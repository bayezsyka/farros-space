            ...
            <div className="py-8">
                <div className="mx-auto max-w-2xl space-y-8">
                    ...
                    <div className="flex items-center justify-between px-2">
                        <div>
                            <Typography variant="h3" className="text-xl font-bold tracking-tight">Postingan Anda</Typography>
                            <Typography variant="muted" className="text-sm">Kelola postingan dan identitas publik Anda.</Typography>
                        </div>
                        <Link 
                            href={route('dashboard.biodata')}
