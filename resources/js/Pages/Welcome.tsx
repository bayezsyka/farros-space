                    ...
                    <div className="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                        <header className="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                            ...
                            <nav className="-mx-3 flex flex-1 justify-end items-center gap-4">
                                <div className="flex gap-2 mr-4 border-r border-gray-300 dark:border-zinc-700 pr-4">
                                    <Link
                                        href="/id"
                                        className={`text-sm ${locale === 'id' ? 'font-bold text-[#FF2D20]' : 'text-black dark:text-white'}`}
                                    >
                                        ID
                                    </Link>
                                    <Link
                                        href="/en"
                                        className={`text-sm ${locale === 'en' ? 'font-bold text-[#FF2D20]' : 'text-black dark:text-white'}`}
                                    >
                                        EN
                                    </Link>
                                </div>
